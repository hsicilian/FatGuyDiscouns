...
export function ShipmentRequestForm({ disabled, canCancel }: { disabled: boolean; canCancel?: boolean }) {
  ...
  return (
    <div style={{ display: "grid", gap: 10 }}>
      ...
      {canCancel ? <CancelShipmentForm submitLabel="Cancel Open Request" /> : null}
    </div>
  );
}
